...
if(!isset($_SESSION['usuario']) && empty($_SESSION['usuario']) || $_SESSION['documento_o_tipoUsuario'] != "vendedor" ) {
...
function traerDatosDeVendedor(){
  include("../configuracion/configuracion.php");
    ...
    $sql = "SELECT * FROM usuarios WHERE tipoUsuario = 'vendedor' AND idUsuario = '$idDelUsuario';";
    ...
    foreach ($lista as $item) {
      array_push($arrayVendedor,$item['mail'],$item['contrasenia']);
    }
    return $arrayVendedor;
}

$vendedorLogueado = traerDatosDeVendedor(); // pongo los datos en un array para futuras comparaciones
...
if ( $vendedorLogueado[1] === $contraseniaActual ) {
  ...
  if($cambioMail === ""){ //si no cambia el mail, éste sigue siendo el mismo
    $cambioMail = "SELECT mail FROM usuarios WHERE tipoUsuario = 'vendedor' AND idUsuario = '$idDelUsuario';";
  ...
  if($contraseniaNueva === ""){ //si no cambia la contraseña, esta sigue siendo la misma
    $contraseniaNueva = "SELECT contrasenia FROM usuarios WHERE tipoUsuario = 'vendedor' AND idUsuario = '$idDelUsuario';";
...
<body>
  ...
  <nav class="navbar-fixed blue" role="navigation">
    <div class="nav-wrapper">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li>
          <form action="interfaz_vendedor.php" method="post">
  ...
  <div class="container" style="padding-top: 5em;padding-bottom: 5em;">
    ...
    <div id="divIngresoAlquileres">
        <div class="row">
            <div class="col s12">
            <form action="interfaz_vendedor.php" method="post" style="padding: 5em;">
              <div class="row">
  ...
  <div class="fixed-action-btn">
    <a class="btn-floating btn-large waves-effect waves-light blue modal-trigger" href="#modalCambioDeInformacionUsuario"><i class="material-icons">mode_edit</i></a>
  </div>
...
<div id="modalCambioDeInformacionUsuario" class="modal">
  <div class="modal-content">
    <div class="container">
      <div class="row">
        ...
        <form class="col s12" action="interfaz_vendedor.php" method="post">
          <div class="row">
  ...
  <script src="../web/js/scripts_vendedor.js"></script>
  <script>
